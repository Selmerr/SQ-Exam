...
6. `06_seed_mock_data_aiven.sql`
7. `07_seed_scene_choice_expansion_aiven.sql`
8. `08_security_roles_aiven.sql`
9. `09_events_aiven.sql` (optional; may fail on managed privileges)
