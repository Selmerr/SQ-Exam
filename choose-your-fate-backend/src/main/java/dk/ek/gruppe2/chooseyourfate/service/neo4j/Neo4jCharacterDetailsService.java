...
@Service
public class Neo4jCharacterDetailsService implements CharacterDetailsDataAccess {

    private static final String MESSAGE = "Neo4j character details functionality is not implemented yet";
