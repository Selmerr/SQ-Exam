...
@Service
public class Neo4jRaceDetailsService implements RaceDetailsDataAccess {

    private static final String MESSAGE = "Neo4j race details functionality is not implemented yet";
