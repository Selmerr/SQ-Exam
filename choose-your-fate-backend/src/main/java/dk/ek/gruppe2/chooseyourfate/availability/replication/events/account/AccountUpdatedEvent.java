...
public record AccountUpdatedEvent(Map<String, Object> payload) implements ReplicationEvent {
    @Override public String entityName() { return "account"; }
    @Override public ReplicationOperationType operationType() { return ReplicationOperationType.UPDATE; }
}